...
[{:set :base,
 ...
 {:set :base,
  ...
  :victory "4",
  :text
  "+3 Power. At the end of your turn, put this card on the bottom of its owner's deck before drawing a new hand. (This card starts the game on top of the Super-Villain stack.)"}
 {:set :base,
